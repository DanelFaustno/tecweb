...
if (!empty($age)&&!empty($sex)){
    if($sex == 'Femenino' || $sex == 'femenino' || $sex == 'FEMENINO' || $sex == 'F' || $sex == 'f'){
		...
		echo "<h1>Error</h1> El registro para hombres no se encuentra disponible";
	}else{
		echo "<h1>Error</h1> Los datos ingresados son incorrectos";
	}
}else{
	echo "<h1>Error</h1> Los campos están vacios o incompletos";
}
?>
	</body>
</html>