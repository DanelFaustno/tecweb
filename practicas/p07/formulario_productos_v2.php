...
<html>
    ...
    <body>
        <h1 align="center">Registrar nuevos productos</h1>
            ...
            <fieldset>
                ...
                <ul>
                    ...
                    <li><label>Marca: </label>
                        <ul>
                            <li><label>HP<input type="radio" id="form-marca" name="form-marca" value="HP"></input></label></li>
                            <li><label>DELL<input type="radio" id="form-marca" name="form-marca" value="DELL"></input></label></li>
                            <li><label>ACER<input type="radio" id="form-marca" name="form-marca" value="ACER"></input></label></li>
                            <li><label>LENOVO<input type="radio" id="form-marca" name="form-marca" value="LENOVO"></input></label></li>
                            <li><label>APPLE<input type="radio" id="form-marca" name="form-marca" value="APPLE"></input></label></li>
                            <li><label>ASUS<input type="radio" id="form-marca" name="form-marca" value="ASUS"></input></label></li></br>
                        </ul>
                    </li>
        ...
        <script>
            ...
            if(nombre == "" || modelo == "" || precio == "" || unidades == ""){
                validacion = false;
                alert('Al parecer tienes campos vacios.');
            }
        ...
        <h1 align="center">Modifica PC´s o laptop</h1>
        ...
        <form id="formularioModProductos" onsubmit="return validar2()" action="http://localhost/tecnologiasweb/practicas/p07/update_producto.php" method="post">
            ...
            <fieldset>
                ...
                <ul>
                    ...
                    <li><label>Marca: </label>
                        <ul>
                            <li><label>HP<input type="radio" id="form-marca_2" name="form-marca_2" value="HP"></input></label></li>
                            <li><label>DELL<input type="radio" id="form-marca_2" name="form-marca_2" value="DELL"></input></label></li>
